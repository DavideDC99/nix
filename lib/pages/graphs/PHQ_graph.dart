...
class BarChartPHQ extends StatefulWidget {
  const BarChartPHQ({super.key});

  @override
  State<StatefulWidget> createState() => BarChartPHQState();
}

class BarChartPHQState extends State<BarChartPHQ> {
  @override
...
class _BarChart3 extends StatelessWidget {
  const _BarChart3();
...
class RangePHQ extends StatelessWidget {
  const RangePHQ({Key? key}) : super(key: key);
          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: const Center(child: Text('Absent  \n0 - 1',
            ...
            Expanded(
              child: Container(
                height: 25,
                color: Colors.green,
                child: const Center(child: Text('Minimal \n1 - 4', 
                style: TextStyle(fontSize: 10, color: Colors.white),
                textAlign:TextAlign.center
                )),
              ),
            ...
            Expanded(
              child: Container(
                ...
                child: const Center(child: Text('Mod. severe \n15 - 19', 
                style: TextStyle(fontSize: 10, color: Colors.white),
                textAlign:TextAlign.center
                )),
              ),
