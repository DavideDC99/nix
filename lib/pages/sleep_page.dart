                                ...
                                children: [
                                  IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        Provider.of<HomeProvider>(context, listen: false).downloadSleep(day.subtract(const Duration(days: 1)));
                                      }),
                                  ...
                                  IconButton(
                                      ...
                                      onPressed: () {
                                        DateTime day = Provider.of<HomeProvider>(context, listen: false).showDate;
                                        Provider.of<HomeProvider>(context, listen: false).downloadSleep(day.add(const Duration(days: 1)));
                                      })
                                ],
                              ),
                            ),
