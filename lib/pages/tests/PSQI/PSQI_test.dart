...
class _PSQITestState extends State<PSQITest> {
          ...
          child: Column(children: [  
            ...
            for (int i = 0; i < 9; i++)
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(14),
                  color: const Color.fromARGB(245, 245, 60, 119),
                ),
                child: Column(
  ...
  _subAnswer(i) {
    ...
    return FlutterToggleTab( 
      ...
      selectedBackgroundColors: const [Color.fromARGB(174, 203, 0, 64), Colors.blueAccent],
    ...
    return Container(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          foregroundColor: isSelected ? Colors.white : Colors.black, backgroundColor: isSelected ? const Color.fromARGB(174, 203, 0, 64) : Colors.white, shape: const StadiumBorder(),
        ),
        onPressed: () {
